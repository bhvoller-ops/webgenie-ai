...
export default async function ProjectPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <AppShell><div className="flex flex-col gap-8">
    ...
    {blueprint ? <section className="rounded-2xl border border-emerald-900 bg-emerald-950/30 p-6">
      <p className="text-sm uppercase tracking-[0.2em] text-emerald-300">Website blueprint</p><h2 className="mt-2 text-2xl font-semibold">{pages.length} implementation-ready pages</h2>
